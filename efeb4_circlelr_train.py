...
CFG = {
    ...
    'weights': [1, 1, 1, 1],
    'expid': f'tf_efficientnet_b3_ns_{time.strftime("%Y-%m-%d-%H:%M:%S", time.localtime())}'
}
            ...
            for phase in ['train', 'val']:
                ...
                for step, (inputs, labels) in enumerate(dataloaders[phase]):
                    ...
                    if phase == 'train':
                        ...
                        # writer.add_scalar(f'train lr', lr, step)
                        writer.add_scalar(f'train loss', step_loss, (epoch + 1) * (step + 1))
                        writer.add_scalar(f'train acc', step_acc, (epoch + 1) * (step + 1))
