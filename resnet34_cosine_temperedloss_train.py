...
CFG = {
    'fold_num': 5,
    'seed': 719,
    'model_arch': 'resnet34_consine_temploss',
    'img_size': 448,
    'epochs': 500,
    'train_bs': 32,
    'val_bs': 32,
    ...
    'weights': [1, 1, 1, 1],
    'expid': f'resnet34_consine_temploss_{time.strftime("%Y-%m-%d-%H:%M:%S", time.localtime())}'
}
...
if __name__ == '__main__':
    ...
    for fold, (trn_idx, val_idx) in enumerate(folds):
        ...
        exp_lr_scheduler = lr_scheduler.CyclicLR(
            ...
            base_lr=CFG['min_lr'],
            max_lr=CFG['lr'],
            step_size_up=step_size_up, base_momentum=0.5, max_momentum=0.9
        )
