...
CFG = {
    ...
    'used_epochs': [9],
    'weights': [1, 1, 1, 1],
    'expid': f'tf_efficientnet_b4_ns_2020-12-30-12:07:52'
...
val_2019_path = '/home/gpuserver/dataset/2019/train'
...
def get_inference_transforms_abm():
    return Compose([
        # Resize(CFG['img_size'], CFG['img_size']),
        RandomResizedCrop(CFG['img_size'], CFG['img_size']),
        Transpose(p=0.5),
...
if __name__ == '__main__':
    ...
    for fold, (trn_idx, val_idx) in enumerate(folds):
        ...
        valid_ds = CassavaDataset(valid_, image_root, transforms=get_inference_transforms(), output_label=True)
        ...
        val_2019 = ImageFolder(val_2019_path, transform=get_valid_transforms())
        val2019_loader = DataLoader(
            val_2019,
