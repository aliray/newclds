...
if __name__ == '__main__':
    ...
    writer = SummaryWriter(f'./tb/{CFG.get("model_arch")}')
    ...
    for fold, (trn_idx, val_idx) in enumerate(folds):
        ...
        exp_lr_scheduler = lr_scheduler.CosineAnnealingLR(optimizer=optimizer, T_max=15)
        model.train()
        dataloaders = {
            'train': train_loader,
            'val': val_loader
            ...
            for epoch in range(CFG.get('epochs')):
                ...
                for phase in ['train', 'val']:
                    ...
                    for step, (inputs, labels) in enumerate(dataloaders[phase]):
                        ...
                        #     writer.add_scalar(f'{phase} acc', step_acc, (epoch + 1) * (step + 1))
                        # if phase == 'val':
                        #     writer.add_figure(f'predictions vs. actuals',
