...
CFG = {
    ...
    'load2019': False,
    'teaching': True,
    'teacherpt_path': '/home/gpuserver/race/race_clds/chk/tf_efficientnet_b4_ns_+temp+loss+0.896'
                      '/tf_efficientnet_b4_ns_0_26.pt',
    'expid': f'ef4_nts_{time.strftime("%Y-%m-%d-%H:%M:%S", time.localtime())}'
}
                ...
                for step, (inputs, labels) in pbar:
                    ...
                    with autocast():
                        ...
                        if phase == 'train':
                            ...
                            scaler.update()
                            optimizer.zero_grad()
                        pbar.set_description(f'{phase} {epoch} {step_acc:.3f}')
