...
from loss.sce_loss import SymmetricCrossEntropy
import math
...
CFG = {
    ...
    'weights': [1, 1, 1, 1],
    'label_smoothing': 0.5,
    'expid': f'resnet50_sloss_{time.strftime("%Y-%m-%d-%H:%M:%S", time.localtime())}'
}
...
if __name__ == '__main__':
    ...
    for fold, (trn_idx, val_idx) in enumerate(folds):
        ...
        criterion = SymmetricCrossEntropy(a=1e-4)
                ...
                for step, (inputs, labels) in enumerate(dataloaders[phase]):
                    ...
                    with autocast():
                        with torch.set_grad_enabled(phase == 'train'):
                            ...
                            # loss = SymmetricCrossEntropy(alpha=0.01)(outputs, labels)
                            if phase == 'train':
