...
if __name__ == '__main__':
    ...
    timpix = time.strftime("%Y-%m-%d-%H:%M:%S", time.localtime())
    tb_path = f'{exp_root}/tb/{expid}/{timpix}'
    chk_root_path = f'{exp_root}/chk/{expid}/{timpix}'
        ...
        for epoch in range(CFG.get('epochs')):
            ...
            for phase in ['train', 'val']:
                ...
                if phase == 'val':
                    torch.save(
                        model.state_dict(),
                        os.path.join(chk_root_path,
                                     f'{model_arch}_{fold}_{epoch}.pt'
                                     )
                    )
